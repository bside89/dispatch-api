...
export class InitialSchema1775596616058 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."outbox_type_enum" AS ENUM('ORDER_PROCESS', 'ORDER_SHIP', 'ORDER_DELIVER', 'ORDER_CANCEL', 'ORDER_REFUND', 'EVENTS_NOTIFY_USER')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('PENDING', 'CONFIRMED', 'PAID', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED')`);
